...
-------
    - having examples: saved as files? commented functions?
    - modify an example without losing acess: history saved?
    - easy to get started: define easy
    - someone who hasnt used the compiler before: lvl of comp knowledge
